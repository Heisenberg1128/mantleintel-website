...
function copy_for(string $language, string $key): string
{
    $copy = [
        ...
        'zh-hk' => [
            'contact' => '聯絡我們', 'use_form' => '請使用查詢表格。', 'use_form_body' => '請返回 Mantle Intelligence，透過聯絡頁面提交試用查詢。',
            'received' => '已收到查詢', 'thanks' => '謝謝。', 'received_body' => '我們已收到您的訊息。',
            'check' => '請檢查資料', 'attention' => '有一項資料需要修正。', 'attention_body' => '請返回表格，填寫姓名、機構、有效工作電郵及希望改善的工作。',
            'rejected' => '未能提交查詢。', 'rejected_body' => '請移除簡短欄位中的換行，然後再試一次。',
            'delivery' => '傳送出現問題', 'not_sent' => '您的訊息未能送出。', 'retry' => '請稍後再次提交表格。',
            'sent' => '試用查詢已送出', 'touch' => '謝謝，我們會與您聯絡。', 'sent_body' => '您的訊息已直接送達 Mantle 創辦團隊。',
        ],
        'zh-cn' => [
            ...
            'check' => '请检查资料', 'attention' => '有一项资料需要修改。', 'attention_body' => '请返回表格，填写姓名、机构、有效工作邮箱及希望改善的工作。',
