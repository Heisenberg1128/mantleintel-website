...
export const pageCopy = {
  ...
  "zh-hk": {
    home: {
      ...
      realWork: "實際工作", realWorkTitle: "由一個工作流程開始，而不是先推動龐大轉型。",
    ...
    vision: {
      ...
      tomorrow: "未來 · 發展方向", tomorrowTitle: "管控 AI 智能體可以執行甚麼。", tomorrowBody: "Agent Workrooms 將探索建議行動、審批、限時授權與稽核證據。",
    ...
    contact: {
      eyebrow: "申請試點", title: "帶來一個真實 AI 工作流程。", intro: "由一個團隊和一條真實政策界線開始。告訴我們，您的工作在哪些地方同時需要 AI 效率與資料、模型或審批控制。",
      fields: { name: "姓名", organisation: "機構", email: "工作電郵", role: "職位", workflow: "您希望探索哪一個 AI 工作流程？", trap: "請留空此欄", submit: "提交試點申請" },
      promiseEyebrow: "保密查詢", promiseTitle: "直接在這裡提交。", promiseBody: "您的訊息會直接送達 Mantle 創辦團隊，毋須開啟外部電郵程式，網站亦不會公開任何私人郵箱。",
      promiseList: ["只需一個流程即可開始。", "您的資料只會用於討論試點或設計夥伴合作。", "提交表格不代表建立客戶關係。"],
    },
    privacy: { title: "私隱政策", intro: "本聲明說明這個公開網站在現階段可能處理的有限資料。", sections: [
      ...
      { title: "第三方服務", body: ["網站由第三方託管及網域服務提供。日後如加入產品影片或查詢服務，可能涉及其他供應商；啟用前應相應更新本聲明。"] },
    ...
    terms: { title: "網站使用條款", intro: "以下初步條款適用於 Mantle Intelligence 公開網站。", sections: [
      { title: "資訊用途", body: ["本網站介紹一家早期公司、現有原型方向及長期產品願景。內容只供一般參考及設計夥伴交流。"] },
      { title: "產品狀態", body: ["網站提及的原型、開發中架構及未來 Agent Workrooms，不代表所有能力已可投入生產或普遍提供。"] },
  ...
  "zh-cn": {
    ...
    privacy: { title: "隐私政策", intro: "本声明说明这个公开网站在现阶段可能处理的有限数据。", sections: [
      ...
      { title: "第三方服务", body: ["网站由第三方托管及域名服务提供。日后如加入产品视频或咨询服务，可能涉及其他供应商；启用前应相应更新本声明。"] },
