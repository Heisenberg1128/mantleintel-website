...
export const metadata: Metadata = { title: "Privacy | Mantle Intelligence", alternates: { canonical: "/privacy" } };
...
export default function PrivacyPage() {
  return <LegalPage title="Privacy notice" intro="This notice describes the limited information this public website may handle at its current stage." sections={[
    ...
    { title: "Questions", body: ["A dedicated business privacy contact will be added when the company mailbox is activated. Until then, this page is a transparent placeholder for counsel review."] },
  ]} />;
}
